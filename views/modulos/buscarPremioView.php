                              ...
                              <tr v-for="premio in search_user.premios">
                                  ...
                                  <td>
                                    ...
                                    <div v-if="premio.premio_id==8">
                                      ...
                                      <p style="margin-top: 10px;">2. Ingresa a tu cuenta y redime tu bono de $5000 para apuestas deportivas con este c&oacute;digo: <div id="codigobetplay" onclick="CopyToClipboard();return false;" style="font-size:20px; color:green">{{ getBetPlayCode(premio.dni) }}</div></p>
