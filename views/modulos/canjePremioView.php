                ...
                <div>
                  ...
                  <div class="card card-sm shadow text-justify border-0" style="height: 40%;">
                    ...
                    <div class="text-white text-justify">
                      <h2 style="text-align: center;">MEGA PROMOCI&Oacute;N &ldquo;DESTAPA TU SUERTE&rdquo;</h2>
                  ...
                  <div class="embed-responsive embed-responsive-16by9" style="border-width: 4px; border-radius: 5px;">
                    <iframe class="embed-responsive-item" style="border: 6px solid #CCCCCC" src="https://youtube.com/embed/G9J01D0H-pU?autoplay=1&amp;controls=1&amp;mute=0"></iframe>
                  </div>
