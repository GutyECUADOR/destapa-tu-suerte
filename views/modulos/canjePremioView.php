...
?> 
                ...
                <div>
                  ...
                  <div class="card card-sm shadow text-justify border-0" style="height: 40%;">
                    ...
                    <div class="text-white text-justify">
                      <h3 style="text-align: center">MEGA PROMOCI&Oacute;N &ldquo;DESTAPA TU SUERTE&rdquo;</h3>
                      ...
                      <p>La actividad promocional &nbsp;<strong>&ldquo;DESTAPA TU SUERTE&rdquo;,</strong> estar&aacute; vigente a partir del quince (15) de noviembre del a&ntilde;o 2021 hasta el d&iacute;a quince (15) de febrero del a&ntilde;o 2022 o hasta agotar existencias, con fecha m&aacute;xima hasta el (quince) 15 de febrero del a&ntilde;o 2023 para que el usuario ganador ingrese a la plataforma <a href="http://www.destapatusuerte.com">www.destapatusuerte.com</a> para la redenci&oacute;n de su premio, sin perjuicio del plazo que conforme a estos T&amp;C se dispone para la entrega de los mismos. &nbsp;</p>
                      ...
                      <p>*El total estimado de premios dispuestos para esta promoci&oacute;n ser&aacute; de 457.431. No obstante, la cantidad definitiva podr&aacute; sufrir variaciones que disminuyan la cantidad total de tapas premiadas, debido a eventualidades en la cadena de producci&oacute;n y distribuci&oacute;n que afecten el producto participante. Sin perjuicio de lo anterior <strong>EL ORGANIZADOR Y RESPONSABLE y/o LA FLA EICE </strong>garantiza que la totalidad del producto promocional saldr&aacute; al mercado en los t&eacute;rminos previstos y no quedar&aacute; con stock o inventario del mismo.</p>
                      ...
                      <p>Los premios ofrecidos en la Promoci&oacute;n corresponden a CUATROCIENTOS CINCUENTA Y SIETE MIL CUATROCIENTOS TREINTA Y UNO (457.431) en total, catalogados y divididos de la siguiente manera con su respectivo valor aproximado incluido IVA. &nbsp;1 de cada 4 tapas de los productos solicitantes est&aacute;n premiadas. *El total estimado de premios dispuestos para esta promoci&oacute;n ser&aacute; de 457.431. No obstante, la cantidad definitiva podr&aacute; sufrir variaciones que disminuyan la cantidad total de tapas premiadas, debido a eventualidades en la cadena de producci&oacute;n y distribuci&oacute;n que afecten el producto participante.</p>
                      
                      <p><strong>PREMIOS TIPO A:</strong> En total: 260 premios a saber:</p>
                      
                      <ol start="5">
                      <li>Motos AKT Ref. NKD 125 cc Cantidad: 10 Unidades&nbsp; Precio aproximado x un . $5.100.000 <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></li>
                      </ol>
                      
                      
                      <ol>
                      <li>Televisores Challenger de 42&rdquo; Cantidad: 50 Unidades. Precio Aproximado x un. $ 1.534.000 <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></li>
                      </ol>
                      ...
                      <p>Precio aprox. x un. $ 870.000 <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></p>
                      
                      
                      <ol start="790">
                      <li>Bicicletas todo terreno 18 velocidades Cantidad: 100 Unidades. Precio aproximado x unidad $ 790.000 <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></li>
                      </ol>
                      
                      <p><strong>PREMIOS TIPO B:</strong> En total: 2.000 premios a saber:</p>
                      
                      <ol start="100">
                      <li>Bono Almacenes &Eacute;xito, de consumo por <strong>Cien mil pesos cada uno (100.000 COP). </strong>Bono electr&oacute;nico Almacenes &Eacute;xito con su documento de identidad, mencionando en el punto de pago el n&uacute;mero de convenio que recibir&aacute; por mensajes de texto SMS. El beneficiario debe gasta el cupo en su totalidad en el primer uso. Entrega en dos (2) d&iacute;as h&aacute;biles. Vigencia: un (1) a&ntilde;o. Este producto no es para redimir en el sitio web de Almacenes &Eacute;xito. Cantidad: 500 Unidades. <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></li>
                      </ol>
                      
                      <ol>
                      <li>Cuentas Amazon Prime (por 1 mes): 1.500 Unidades. Precio estimado $ 25.000 pesos c/u. <strong>(En caso de agotar las existencias por disponibilidad de algunos de los premios, se entregar&aacute; un premio similar o de mejores caracter&iacute;sticas, <u>NUNCA INFERIOR</u>).</strong></li>
                      </ol>
                      ...
                      <p><strong>Cada participante identificado con (Nombre y C&eacute;dula) puede ganar un m&aacute;ximo de 5 bonos BetPlay para apostar.</strong></p>
                      ...
                      <p>Premios Giro por cien mil pesos ($100.000) &Eacute;XITO</p>
                      ...
                      <p>El valor del premio se realizar&aacute; a trav&eacute;s de un BONO DIGITAL al nombre y c&eacute;dula del USUARIO GANADOR registrado y &eacute;ste podr&aacute; hacerlo efectivo en cualquier punto &eacute;xito en el territorio nacional.</p>
                      ...
                      <p>Recargas de CINCO MIL PESOS $5.000 para apuestas en l&iacute;nea bajo la plataforma Betplay</p>
                      ...
                      <p>NOTA: Para todos los casos, esto es premios tipo A, premios Tipo B y Premios tipo C, el usuario ganador tendr&aacute; plazo hasta el 15 de febrero del 2023 para ingresar a la plataforma <a href="http://www.destapatusuerte.com">www.destapatusuerte.com</a> el c&oacute;digo ganador, sin perjuicio de la fecha de la compra, fecha en la cual empezar&aacute; a correr los t&eacute;rminos para la entrega del premio.</p>
                      ...
                      <p>El canal de atenci&oacute;n para peticiones, quejas, reclamos, solicitudes o inquietudes que tenga el&nbsp;&nbsp; usuario respecto de la Promoci&oacute;n ser&aacute;: soportedestapatusuerte@gmail.com o en su defecto al WhatsApp no. (57) 3154771684. <strong>El centro de contacto cuenta con 72 horas para responder las peticiones, quejas, reclamos, solicitudes e inquietudes de participantes de la promoci&oacute;n.</strong></p>
                  ...
                  <div class="embed-responsive embed-responsive-16by9" style="border-width: 4px; border-radius: 5px;">
                    <iframe class="embed-responsive-item" style="border: 6px solid #CCCCCC" src="https://youtube.com/embed/A6D7_Qzq1Yo?autoplay=1&amp;controls=1&amp;mute=0"></iframe>
                  </div>
    ...
    <script type="text/javascript" src="assets/js/libs/jquery.fireworks-main.js"></script>
