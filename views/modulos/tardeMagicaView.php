...
<div class="main-container">
    ...
    <section class="text-light" style="background: url('./assets/img/tardemagica/fondo.png'); padding: 0 !important">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-6 text-center">
                    <img src="assets/img/tardemagica/bodegonPremios.png" alt="premios" class="img-responsive w-100 zoom">
                </div>
            </div>
